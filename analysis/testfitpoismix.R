...
# Create the data set. The right-most column of L has small entries.
...
# Fit the model.
out1 <- fitpoismix(L,w,x0,numiter = 20,qp.solver = "activeset")
out2 <- fitpoismix(L,w,x0,numiter = 20,qp.solver = "quadprog")
print(out1$x - out2$x)
