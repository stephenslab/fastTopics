...
introduce the basic concepts and fastTopics interface through a simple
example. This first vignette is only intended to explain the topic
model analysis at a high level---see [Part 2][vignette-part-2] for
additional explanations and guidance.
...
[Part 2][vignette-part-2].) In the PBMC 4k data, the cells were labeled
