...
Each cell is represented by a unique mixture of the topics
----------------------------------------------------------
...
data, separately for each cell. Each cell can therefore be summarized
the $K$ mixture proportions. The mixture proportions for all cells are
