...
B cells, by a factor of $2^5 = 32$ times, or more; by contrast these
two genes are underexpressed in the other four cell types:
...
(topic 4), particularly so for *CD79A*. In fact, *CD79A* is nearly
...
support. Indeed, B-cell genes, among them *CD79A* and *CD79B*, appear
near the top-right corner of the volcano plot.
...
See [Part 2][vignette-part-2] for more DE analysis examples.
