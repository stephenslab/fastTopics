...
interpretation to a standard DE analysis. To illustrate, the LFC
estimates are largest for *CD79A* and *CD79B*, two marker genes for B
cells, in the "B cells topic" (topic 4):
...
have a small lfsr (local false sign rate). Indeed, *CD79A* is on the
far right-hand side of the plot.
