...
We show how fastTopics can be used to quickly implement each of these
steps.
...
Beyond fastTopics and the Matrixx package, we use ggplot2 and cowplot
to visualize the results of the topic modeling analysis.
...
Visualize mixture proportions with a Structure plot
---------------------------------------------------

*Add text here.*

```{r structure-plot, fig.width=5.5, fig.height=1.5, results="hide"}
topic_colors <- c("skyblue","forestgreen","darkmagenta","dodgerblue","gold",
                  "darkorange")
structure_plot(fit_multinom,topics = 1:6,colors = topic_colors)
```
