...
These PCA plots illuminate the clusters and other substructure. The
PCA "hexbin" density plot can be helpful when there are many
overlapping cells in the PCA plot.
...
each largely characterised by a single factor. The NK and T cells is
