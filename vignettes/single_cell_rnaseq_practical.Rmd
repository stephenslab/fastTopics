...
```{r structure-plot-without-labels, fig.width=6.5, fig.height=1.5, results="hide", message=FALSE, eval=FALSE}
...
```{r structure-plot-by-cluster-1, fig.width=7.5, fig.height=1.75, results="hide", message=FALSE, eval=FALSE}
structure_plot(fit,topics = 1:6,colors = topic_colors,
...
```{r structure-plot-by-cluster-2, fig.width=7.5, fig.height=1.75, results="hide", message=FALSE, eval=FALSE}
...
```{r structure-plot-by-cluster-3, fig.width=7.5, fig.height=1.75, results="hide", message=FALSE, eval=FALSE}
...
```{r volcano-plot-cd8, fig.height=3.5, fig.width=4.5, results="hide", eval=FALSE}
