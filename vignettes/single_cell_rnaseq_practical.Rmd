...
We emphasize that this example is only meant to illustrating
clustering the cells by the mixture proportions, and *k*-means may not
be the best clustering technique for all data sets. For more complex
data sets, some ingenuity may be required to identify and visualize
