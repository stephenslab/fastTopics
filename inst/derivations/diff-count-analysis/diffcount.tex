...
quantifies the {\em relative} log-fold change. To show this, we
consider an alternative gene expression model:
\begin{align}
x
\end{align}
where ... [Give (relative) log-fold change statistic.] This model is
in fact is equivalent to the binomial model \eqref{eq:binomial}, and
therefore estimating $f_0, f_1$ in the binomial model provides an
