...
\eqref{eq:poisson}, we begin with the log-likelihood,
\begin{equation}
...
or $f_1$. The partial derivatives of the log-likelihood are
\begin{align}
\frac{\partial\ell}{f_0} &= 
\sum_{i=1}^n \frac{x_i - t_i\lambda_i}{\lambda_i} \times (1-q_i) \\
\frac{\partial\ell}{f_1} &= 
\sum_{i=1}^n \frac{x_i - t_i\lambda_i}{\lambda_i} \times q_i.
\end{align}

There is a simple EM algorithm for fitting the Poison model
