...
computed without seeing the data. This same expression also works with
the for the parameters of multinomial topic model $l_{ik}, f_{jk}$ so
long as they are MLEs (proof not shown).
