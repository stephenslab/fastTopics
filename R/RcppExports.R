...
altsqp_main_loop_rcpp <- function(X, F, Fn, Fy, Fbest, L, Ln, Ly, Lbest, f, fbest, verbose) {
    .Call('_fastTopics_altsqp_main_loop_rcpp', PACKAGE = 'fastTopics', X, F, Fn, Fy, Fbest, L, Ln, Ly, Lbest, f, fbest, verbose)
}
