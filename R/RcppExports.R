...
altsqp_update_factors_parallel_rcpp <- function(X, F, L, numiter, control) {
    .Call('_fastTopics_altsqp_update_factors_parallel_rcpp', PACKAGE = 'fastTopics', X, F, L, numiter, control)
}

altsqp_update_factors_sparse_parallel_rcpp <- function(X, F, L, numiter, control) {
