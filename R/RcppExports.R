...
binom_stats_rcpp <- function(X, F, L) {
    .Call('_fastTopics_binom_stats_rcpp', PACKAGE = 'fastTopics', X, F, L)
}
...
compute_poisson_precision_beta_sparse_rcpp <- function(X, L, F0, F1) {
    .Call('_fastTopics_compute_poisson_precision_beta_sparse_rcpp', PACKAGE = 'fastTopics', X, L, F0, F1)
}
...
fit_poisson_em_sparse_rcpp <- function(x, s, q, a, b, f0, f1, e, numiter) {
    .Call('_fastTopics_fit_poisson_em_sparse_rcpp', PACKAGE = 'fastTopics', x, s, q, a, b, f0, f1, e, numiter)
}
