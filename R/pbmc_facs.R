...
#'   molecular identifier (UMI) counts for 16,791 genes in 3,774
#'   cells. (Genes with no expression in any of the cells were removed.)
#'   Since the majority of the UMI counts are zero, they are efficiently
